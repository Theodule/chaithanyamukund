...
var MeetingZone = function($element) {
  ...
  this.moveOut = function() {
    ...
    $meeting.animate({opacity: 0.5}, 'quick');
  }
}
...
$(document).ready(function() {
  ...
  var CLOUDS = [
    // {top: "400", offset: "-450px", css_class: "cloud-1", delay: .8, link: "Gallery", css_class: "gallery-cloud", href: 'gallery.html'},
    // {top: "500", offset: "320px", css_class: "cloud-3", delay: 1.2, link: "Wishes", css_class: "gallery-cloud"},
    ...
    {top: "5850", offset: "-570px", css_class: "cloud-2 md-trigger", delay: .1, link: "Venue", attr: true}
  ];

  var zoneControllers = {
    "zone-beginning" : new BeginningZone($("#sun")),
  ...
  function setUpNavigation() {
    $("nav li").click(function(e) {
      ...
      $('html, body').animate({
        scrollTop: $moment.offset().top - $moment.height() / 2 + hiddenBalloonHeight
      }, 1000);
